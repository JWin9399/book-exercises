...
paycuts <- salaries[salaries$got_raise == FALSE, "adjustments"]     # All the same result
mean(paycuts)
...
people_csv <- read.csv("example.csv", stringsAsFactors = FALSE) #this will not run on your computer, you dont's have the file
getwd() # like pwd
